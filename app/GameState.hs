...
drawGame gameState = return $ translate (-144) (-144) $ scale 32 32 $ pictures [
...
chooseColor cell
  | isRevealed cell = if isMine cell then red
                      else if isFlagged cell then yellow
                      else greyN 0.5
